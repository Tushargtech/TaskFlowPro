...
$attachmentObj = new Attachment($pdo);
...
switch ($resource) {
    ...
    case 'tasks':
        ...
        break;
    case 'attachments':
        handleAttachments($method, $id, $action, $attachmentObj);
        break;
    default:
